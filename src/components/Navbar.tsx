        ...
        >
          ...
          >
            ...
            <div className="hidden md:grid md:grid-cols-[auto_1fr_auto] md:items-center md:gap-6">
              ...
              >
                <div className="relative h-9 w-9 sm:h-10 sm:w-10">
                  <Image
                    ...
                    alt="HackBVP"
                    fill
                    className="object-contain drop-shadow-[0_0_12px_rgba(108,127,255,0.35)]"
                    priority
                  />
                </div>
              ...
              <Link
                href="#register"
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold text-white whitespace-nowrap transition-all duration-200 hover:opacity-90 shadow-[0_0_20px_rgba(108,127,255,0.25)]"
          ...
          >
            <div
              className={`rounded-2xl border border-white/15 bg-[#070814]/90 backdrop-blur-2xl shadow-[0_24px_64px_rgba(0,0,0,0.65)] ring-1 ring-white/10 p-2 mx-0.5 ${
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <Link
                  ...
                  style={{ background: "var(--primary)", boxShadow: "0 0 24px rgba(108,127,255,0.35)" }}
                >
                  Register Now
                </Link>
              </div>
